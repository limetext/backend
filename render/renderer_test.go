...
func TestRecipeTranscribe(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			TranscribedRecipe{{flavourA, text.Region{A: 0, B: 1}}},
		},
		{
			Recipe{flavourA: text.RegionSet{}},
			map[Flavour][]text.Region{flavourA: {{0, 1}, {10, 11}}},
			TranscribedRecipe{{flavourA, text.Region{A: 0, B: 1}}, {flavourA, text.Region{A: 10, B: 11}}},
		},
		{
		...
		},
		{
			...
			TranscribedRecipe{{flavourA, text.Region{A: 0, B: 1}}, {flavourB, text.Region{A: 10, B: 11}}},
		},
		{
			Recipe{flavourA: text.RegionSet{}, flavourB: text.RegionSet{}},
			map[Flavour][]text.Region{flavourA: {{0, 11}}, flavourB: {{0, 1}}},
			TranscribedRecipe{{flavourB, text.Region{A: 0, B: 1}}, {flavourA, text.Region{A: 0, B: 11}}},
		},
	}
